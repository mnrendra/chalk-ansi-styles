...
describe('Test all features:', () => {
  it('Should only have modifier, foreground, and background keys!', () => {
    const received = Object.keys(index)
